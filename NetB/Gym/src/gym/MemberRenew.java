 ...
 * MemberRenew.java
 *
 * Created on May 6, 2015, 6:09:19 PM
 */
package gym;
 ...
 * @author ManoJ
 */
public class MemberRenew extends javax.swing.JInternalFrame {

    /** Creates new form MemberRenew */
    public MemberRenew() {
        initComponents();
    }
...
private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
    ...
    try{       
     ...
     pstmt = con.prepareStatement(query); 
      ...
      pstmt.setString(4, "Member Renew"); 
      pstmt.setString(5,tMemId.getText() ); 
 
      pstmt.executeUpdate(); 
     
     JOptionPane.showMessageDialog(null,"Member Renew Payment Added..!");
